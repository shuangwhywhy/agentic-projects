...
1. 先补 `术语与对象词汇表`
2. 再补 `开放问题注册表`
3. 再补 `Repo 1 -> Repo 2 handoff packet 模板`
4. 再补 `Layer 3 架构任务启动模板`
5. 再补 `Layer 4 实现追溯模板`
6. 最后补 `用户端点职责草图与汇报节奏原型`

这个顺序的理由是：

- 先统一语言，才能减少后续误解
- 先管理开放项，才能避免“未决问题伪装成已决”
